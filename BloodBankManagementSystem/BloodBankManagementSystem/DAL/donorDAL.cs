    ...
    class donorDAL
    {
        ...
        public bool Insert(donorBLL d)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO donor (donor_id, donor_name, blood_group, last_donation_date, contact, gender, address) VALUES (@donor_id, @donor_name, @blood_group, @last_donation_date, @contact, @gender, @address)";
                ...
                cmd.Parameters.AddWithValue("@donor_name", d.donor_name);
                cmd.Parameters.AddWithValue("@blood_group", d.blood_group);
                cmd.Parameters.AddWithValue("@last_donation_date", d.last_donation_date);
        ...
        public bool Update(donorBLL d)
        {
            ...
            try
            {
                ...
                string sql = "UPDATE donor SET donor_name=@donor_name, email=@email, contact=@contact, gender=@gender, address=@address, blood_group=@blood_group, image_name=@image_name, added_by=@added_by WHERE donor_id=@donor_id";
        ...
        public string countDonors(string blood_group)
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM donor WHERE blood_group = '" + blood_group +"'";
        ...
        public DataTable Search(string keywords)
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM donor WHERE donor_id LIKE '%" + keywords +"%' OR donor_name LIKE '%"+keywords+"%' OR last_donation_date LIKE '%"+ keywords +"%' OR blood_group LIKE '"+keywords+"'";
